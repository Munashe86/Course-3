        ...
        features: [
          {
            ...
            description: 'Continuous server health and performance monitoring'
          },
          {
            title: 'Security',
            description: 'Advanced firewall and SSL protection included'
          },
          {
            title: 'Backup System',
            description: 'Daily automated backups with instant restoration'
          }
        ],
        benefits: [
